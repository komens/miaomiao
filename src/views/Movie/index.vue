       ...
       <div id="content">
           <div class="movie_menu">
				<router-link tag="div" to="city" class="city_name">
					<span>大连</span><i class="iconfont">&#xe68d;</i>
				</router-link>
				<div tage="div" class="hot_swtich">
					<router-link tag="div" to="nowplaying" class="hot_item">正在热映</router-link>
					<router-link tag="div" to="comingsoon" class="hot_item active">即将上映</router-link>
				</div>
